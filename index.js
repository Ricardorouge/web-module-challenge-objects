...
*/
createMenuItem('burrito',12,'Lunch');
createMenuItem('scrambled eggs',4,'BreakFast');
createMenuItem('orange juice',3,'Drinks');
...
function getLongReviews(array) {
  ...
  console.log('testesttest',getLongReviews(reviews));
